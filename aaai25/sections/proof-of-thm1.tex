...
\begin{align}\label{eq:2}
	\begin{split}
	\Pr\left[\bigcap_{k \in S'} F_k \mid \bigcap_{k \in S'} E_k\right] &    \geq  \Pr\left[\bigcap_{k \in S'} F_k \mid \bigcap_{k \in S'} E_k \cap \{k \in S\} \!\right] \\
...
\begin{align*}
	...
	&\geq (1-\gamma) \Pr\left[S = S^\star \cap \bigcap_{k \in S^\star} F_k \mid \bigcap_{k \in S^\star} E_k \right]\\
