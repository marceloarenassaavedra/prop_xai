...
\affiliations {
    % Affiliations
    \textsuperscript{\rm 1}Pontificia Universidad Católica de Chile, IMFD Chile and RelationalAI\\
    \textsuperscript{\rm 2}Carnegie Mellon University\\
    \textsuperscript{\rm 3}Georgia Institute of Technology and University of Toronto\\
    marenas@uc.cl, bsuberca@cs.cmu.edu, meel@cs.toronto.edu 
}
