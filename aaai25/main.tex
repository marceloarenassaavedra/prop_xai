...
\affiliations {
    ...
    \textsuperscript{\rm 2}Pontificia Universidad Católica de Chile\\
    \textsuperscript{\rm 3}IMFD Chile\\
    \textsuperscript{\rm 4}RelationalAI\\
    \textsuperscript{\rm 5}Georgia Institute of Technology\\
    \textsuperscript{\rm 6}University of Toronto\\
...
\begin{links}
    \link{Extended version}{https://arxiv.org/abs/2501.00154}
\end{links}
