...
\title{Probabilistic Explanations for Linear Models\thanks{
		The full version of the paper is available at \protect\url{https://arxiv.org/abs/}.  \newline
		The authors
...
\affiliations {
    ...
    \textsuperscript{\rm 2}Pontificia Universidad Católica de Chile, IMFD Chile and RelationalAI\\
    \textsuperscript{\rm 3}Georgia Institute of Technology and University of Toronto\\
  %  bersub@cmu.edu, marenas@uc.cl, meel@gatech.edu
}
